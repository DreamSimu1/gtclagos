...
//           `${apiUrl}/api/ai/fin-inquiry/last-7-days`,
//           {
//             headers: {
...
//           // Flatten the outer array of arrays into a single array of message objects
//           const flattenedMessages = response.data.data.flat();

//           // Then reverse and map
//           const chatMessages = flattenedMessages
//             .slice()
//             .reverse()
//             .flatMap((msg) => [
//               {
